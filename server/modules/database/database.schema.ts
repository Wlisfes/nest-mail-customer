...
export * from '@server/modules/database/schema/tb_mail_template'
export * from '@server/modules/database/schema/tb_mail_template_category'
export * from '@server/modules/database/schema/tb_mail_template_variable'

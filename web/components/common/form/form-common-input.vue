    ...
    setup(props, { emit, slots }) {
        function fetchPrefixRender() {
            if (slots.prefix) {
                ...
                return <common-global-wrapper name={props.prefix.name} size={props.prefix.size ?? 18} />
            }
        ...
        function fetchSuffixRender() {
            if (slots.suffix) {
                ...
                return <common-global-wrapper name={props.suffix.name} size={props.suffix.size ?? 18} />
            }

    ...
    setup(props, { emit, slots }) {
        ...
        function fetchIconRender() {
            if (isEmpty(props.icon)) {
                ...
                return <common-global-wrapper size={props.iconSize} name={props.icon}></common-global-wrapper>
            }
        ...
        return () => (
            <n-button
                class={{ 'common-global-button': true, 'element-database': props.database }}
...
.common-global-button.element-database {
    --n-icon-margin: 3px;
}
</style>
